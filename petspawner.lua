...
frame.InputChanged:Connect(function(input)
    if dragging and-- Pet Spawner Premium — Mobile-Friendly Version
-- Draggable bottom bar for moving the UI (desktop & mobile)
-- Hovering the bottom bar expands/thickens and changes color
-- Touch/click drag: moves window
...
end) (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then-- Pet Spawner Premium — Mobile-Friendly Version
-- Draggable bottom bar for moving the UI (desktop & mobile)
-- Hovering the bottom bar expands/thickens and changes color
-- Touch/click drag: moves window
